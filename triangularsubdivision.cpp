...
template <typename Point> void TriangularSubdivision<Point>::copy(const TriangularSubdivision<Point> &other, std::shared_ptr< std::vector<Point> > points)
{
    ...
    else
    {
        ...
        A = std::unique_ptr<TriangularSubdivision<Point>>(new TriangularSubdivision());
        B = std::unique_ptr<TriangularSubdivision<Point>>(new TriangularSubdivision());
        C = std::unique_ptr<TriangularSubdivision<Point>>(new TriangularSubdivision());
        O = std::unique_ptr<TriangularSubdivision<Point>>(new TriangularSubdivision());
