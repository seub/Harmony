...
enum actionHandlerMessage {HIGHLIGHTED_LEFT, HIGHLIGHTED_RIGHT, HIGHLIGHTED_RESET, END_CANVAS_REPAINT};
enum showTranslatesChoice {SHOW_TRANSLATES_CHOOSE, SHOW_TRANSLATES_DOMAIN, SHOW_TRANSLATES_VERTEX, SHOW_TRANSLATES_VERTICES};
enum setRhoChoice {SET_RHO_CHOOSE, SET_RHO_NICE, SET_RHO_RANDOM, SET_RHO_FN, SET_RHO_DEHNTWIST};
